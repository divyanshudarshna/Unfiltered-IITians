...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full border content-center bg-border/20 hover:bg-border/40 transition duration-500 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
