...
export const ADMIN_PERMISSION_DEFINITIONS = {
  ...
  courses: { label: "Manage Courses", group: "Courses", routePrefixes: ["/admin/courses"], apiPrefixes: ["/api/admin/courses"] },
  course_details: { label: "Manage Details", group: "Courses", routePrefixes: ["/admin/course-details"], apiPrefixes: ["/api/admin/course-details", "/api/admin/contents", "/api/admin/lectures"] },
