...
// ✅ PHASE 2: Heavy aggregation endpoint - perfect candidate for caching!
export async function GET() {
  const cacheKey = CacheKeys.admin.dashboardStats();

  // ✅ Cache for 5 minutes (300s) - dashboard stats don't need real-time accuracy
  const stats = await getOrSet(
    ...
    300 // ✅ Cache for 5 minutes - reduce load on database
  );
