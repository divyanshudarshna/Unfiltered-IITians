...
const skills = [
  ...
  {
    icon: <Microscope className="w-6 h-6 text-green-400" />,
  ...
  {
    icon: <PenSquare className="w-6 h-6 text-teal-400" />,
    title: "Copywriting",
    content:
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8  text-slate-200">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-500 via-cyan-400 to-blue-500 bg-clip-text text-transparent mb-4">
          ...
          const CardInner = (
            <Card
              className={`relative h-full transition-all duration-500
                ...
                hover:before:border-violet-500 hover:before:shadow-[0_0_25px_5px_rgba(139,92,246,0.5)]`}
            >
              <CardHeader className="flex flex-row items-center space-x-4 relative z-10">
                <div className="p-3 rounded-md bg-slate-700">{skill.icon}</div>
                <CardTitle className="text-lg font-semibold text-slate-200">
                  {skill.title}
                </CardTitle>
              </CardHeader>
              <CardContent className="relative z-10">
                <p className="text-slate-300">{skill.content}</p>
