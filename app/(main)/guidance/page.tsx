...
export default function GuidancePage() {
  ...
  return (
    <div className="container mx-auto px-6 py-10">
      <h1 className="text-5xl font-bold text-center mb-10 text-primary">Available Sessions</h1>
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {loading || enrolledSessionIds === null
          ...
          : sessions.map((session) => {
              ...
              <Testimonials button={true} title="Student Reviews" description="Hear from students who have transformed their academic journey with personalized guidance" />
